...
def writeHTML(model,name):
    ...
    #Extracting length, width and volue from walls and creating HTML subssection for walls
    for wall in walls: 
    ...
    #Creating input field and buttions for each material
